INSERT INTO patient(id, pesel, name, surname, kartoteka, przychodnia, kasa_Chorych, city, street, house_Number, home_Number) values
...
INSERT INTO doctor(id, name, surname, przychodnia, on_Moring, monday, tuesday, wednesday, thursday, friday) values
